  ...
  export default {
    ...
    data () {
      return {
        ...
        data: [
          {
            "text": "1 Same but with checkboxes",
            "children": [
              {
                "text": "1-1 initially selected",
                "selected": true
              },
              {
                "text": "1-2 custom icon",
                "icon": "fa fa-warning icon-state-danger"
              },
              {
                "text": "1-3 initially open",
                "icon": "fa fa-folder icon-state-default",
                "opened": true,
                "children": [
                  {
                    "text": "1-3-1 Another node"
                  }
                ]
              },
              {
                "text": "1-4 custom icon",
                "icon": "fa fa-warning icon-state-warning"
              },
              {
                "text": "1-5 disabled node",
