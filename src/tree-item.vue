    ...
    export default {
        ...
        computed: {
            ...
            classes() {
                return [
                    ...
                    {'tree-drag-enter-before': this.isDragEnterAfter},
                    {'tree-drag-enter-after': this.isDragEnterBefore},
        ...
        methods: {
            dragEnterHandler(e) {
                ...
                const orderPositionPercent = .10
                console.debug(row_height, e.offsetY,
                    row_height * orderPositionPercent - e.offsetY,
                    row_height * (1.0 - orderPositionPercent) - e.offsetY
                )
                this.isDragEnterAfter = this.isDragEnterBefore = this.isDragEnter = null;
                if (row_height * orderPositionPercent - e.offsetY < 0) {
                    console.log("drag before")
                    this.isDragEnterBefore = true
                } else {
                    if (row_height * (1.0 - orderPositionPercent) - e.offsetY < 0) {
            ...
            handleItemDrop(e, oriNode, oriItem) {
                ...
                this.isDragEnterAfter = this.isDragEnterBefore = null;
